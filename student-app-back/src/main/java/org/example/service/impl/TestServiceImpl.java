...
public class TestServiceImpl implements TestService {
  ...
  public TestDto getTest(String studentId) {
    var test = testRepository.findByStudent(studentRepository.findById(studentId).get());
  ...
  public void deleteTest(String studentId) {
    testRepository.delete(
        testRepository.findByStudent(studentRepository.findById(studentId).get()).get());
  }
}
