...
class StudentProjectWorkshopServiceTest {
    ...
    @Mock
    private StudentProjectWorkshopMapper studentProjectWorkshopMapper;

    @InjectMocks
    private StudentProjectWorkshopServiceImpl studentProjectWorkshopService;
    ...
    void getAllStudents() {
        ...
        when(studentProjectWorkshopMapper.toStudentInfoDto(student1ProjectWorkshop)).thenReturn(student1InfoDto);
        when(studentProjectWorkshopMapper.toStudentInfoDto(student2ProjectWorkshop)).thenReturn(student2InfoDto);

        var expectedStudentInfoList = List.of(student1InfoDto, student2InfoDto);

        //Act
        var gettedStudentInfoList = studentProjectWorkshopService.getAllStudents();
    ...
    void getStudentProjectWorkshopById() {
        ...
        when(studentProjectWorkshopRepository.findById(studentProjectWorkshopId)).thenReturn(Optional.of(student));
        //Act
        var gettedStudent = studentProjectWorkshopService.getStudentProjectWorkshopById(studentProjectWorkshopId);
    ...
    void getStudentProjectWorkshopByIdWithStudentProjectWorkshopNotFoundException() {
        //Arrange
        var studentProjectWorkshopId = 1L;
        when(studentProjectWorkshopRepository.findById(studentProjectWorkshopId)).thenReturn(Optional.empty());
        //Act & Assert
        assertThrows(StudentProjectWorkshopNotFoundException.class, () -> {
    ...
    void createStudentProjectWorkshop() {
        ...
        when(projectWorkshopService.getLastProjectWorkshopId()).thenReturn(lastProjectWorkshopId);
        when(projectWorkshopRepository.findById(lastProjectWorkshopId)).thenReturn(Optional.of(projectWorkshop));
    ...
    void createStudentProjectWorkshopWithProjectWorkshopNotFoundException() {
        ...
        //Act & Assert
        assertThrows(ProjectWorkshopNotFoundException.class, () -> {
            studentProjectWorkshopService.createStudentProjectWorkshop(studentId);
        });
    }
    ...
    void getTeam() {
        ...
        when(studentProjectWorkshopMapper.toStudentInTeamDto(student1ProjectWorkshop)).thenReturn(student1InTeam);
        when(studentProjectWorkshopMapper.toStudentInTeamDto(student2ProjectWorkshop)).thenReturn(student2InTeam);
