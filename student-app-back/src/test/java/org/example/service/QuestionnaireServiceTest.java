...
class QuestionnaireServiceTest {
  ...
  void getQuestionnaireByStudentId() {
    ...
    when(questionnaireMapper.toQuestionnaireDto(questionnaireEntity)).thenReturn(questionnaireDto);
  ...
  void updateQuestionnaire() {
    ...
    when(questionnaireMapper.toQuestionnaireEntity(
            questionnaireDto, studentProjectWorkshop, questionnaireEntity.getId()))
        .thenReturn(updatedQuestionnaireEntity);

    when(questionnaireRepository.save(updatedQuestionnaireEntity))
        .thenReturn(updatedQuestionnaireEntity);
