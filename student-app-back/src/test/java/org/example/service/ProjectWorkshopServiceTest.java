...
class ProjectWorkshopServiceTest {
    ...
    void addStudent() {
        ...
        when(projectWorkshopRepository.findById(projectWorkshopId)).thenReturn(Optional.of(projectWorkshop));
    ...
    void getProjectWorkshops() {
        ...
        var projectWorkshopEntityList = List.of(
                projectWorkshopEntity1,
                projectWorkshopEntity2);
        ...
        var expectedProjectWorkshopDtoList = List.of(
                projectWorkshopDto1,
                projectWorkshopDto2);

        when(projectWorkshopRepository.findAll()).thenReturn(projectWorkshopEntityList);
        when(projectWorkshopMapper.toProjectWorkshopDto(projectWorkshopEntity1)).thenReturn(projectWorkshopDto1);
        when(projectWorkshopMapper.toProjectWorkshopDto(projectWorkshopEntity2)).thenReturn(projectWorkshopDto2);
    ...
    void getProjectWorkshopById() {
        ...
        when(projectWorkshopRepository.findById(projectWorkshopId)).thenReturn(Optional.of(projectWorkshopEntity));
        when(projectWorkshopMapper.toProjectWorkshopDto(projectWorkshopEntity)).thenReturn(projectWorkshopDto);
    ...
    void getTeams() {
        ...
        when(studentProjectWorkshopMapper.toStudentInTeamDto(studentProjectWorkshop1)).thenReturn(student1InTeamDto);
        when(studentProjectWorkshopMapper.toStudentInTeamDto(studentProjectWorkshop2)).thenReturn(student2InTeamDto);
        when(projectWorkshopRepository.findById(projectWorkshopId)).thenReturn(Optional.of(projectWorkshopEntity));
